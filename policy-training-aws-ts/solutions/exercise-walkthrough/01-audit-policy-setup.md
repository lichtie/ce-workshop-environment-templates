...
> **About the audit group:** The audit policy group is for your visibility only — it evaluates your stacks and surfaces findings in the console, but developers never see warnings or blocked deployments. This is useful when you want to understand how close your infrastructure is to compliance before you start enforcing anything. Think of it as a read-only view of your policy posture.

---

**Next:** [02 — Preventative Policy Setup](02-preventative-policy-setup.md)
